import { HouseholdRecord, CardRecord, ComparisonResult, Discrepancy } from '../types';
 ...
 * @returns 比較結果
 */
export function performComparison(householdArr: HouseholdRecord[], cardArr: CardRecord[]): ComparisonResult {
    ...
    const finalCardOnly = cardArr.filter((_, idx) => !matchedCardIndices.has(idx));
