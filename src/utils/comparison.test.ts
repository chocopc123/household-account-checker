...
describe('performComparison', () => {
    const mockHousehold: HouseholdRecord[] = [
        { '日付': '2023-10-01', '資産': '資産A', '収入/支出': '支出', '分類': '食費', '小分類': 'スーパー', '内容': '買い物1', '金額(￥)': 1000 },
        { '日付': '2023-10-05', '資産': '資産A', '収入/支出': '支出', '分類': '日用品', '小分類': 'ドラッグストア', '内容': '買い物2', '金額(￥)': 2000 },
        { '日付': '2023-10-10', '資産': '資産A', '収入/支出': '支出', '分類': '食費', '小分類': '外食', '内容': 'ランチ', '金額(￥)': 1500 },
    ];
    ...
    it('同一金額が複数ある場合に最も近い日付が選ばれること', () => {
        const household: HouseholdRecord[] = [
            { '日付': '2023-10-01', '資産': 'A', '収入/支出': '支出', '分類': 'B', '小分類': 'C', '内容': 'H1', '金額(￥)': 500 },
        ];
